namespace ViarusTask
{
    ...
    { 
        ...
        public static int KEYCODE_BUTTON_VIARUS = 110;
        ...
        public static int GESTURE_RELAX = 0; 
        public static int GESTURE_GIST = 1; 
        public static int GESTURE_SPREAD_FINGERS = 2; 
        public static int GESTURE_WAVE_TOWARD_PALM = 3; 
        public static int GESTURE_WAVE_BACKWARD_PALM = 4; 
        public static int GESTURE_TUCK_FINGERS = 5; 
        public static int GESTURE_SHOOT = 6; 
        public static int GESTURE_MAX = GESTURE_SHOOT; 
        public static int GESTURE_UNKNOWN = 255; 
