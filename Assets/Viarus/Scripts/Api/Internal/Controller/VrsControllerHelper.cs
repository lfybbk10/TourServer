...
{
    public class VrsControllerHelper
    {
        ...
        public static void Reset()
        {
            ...
            ControllerType = (int)VrsInstantNativeApi.ViarusControllerId.NONE;
        }
        ...
        public static void InitController(int type)
        {
            ...
            switch (type)
            {
                case (int)VrsInstantNativeApi.ViarusControllerId.NOLO:
                    IsLeftNoloControllerConnected = true;
                    IsRightNoloControllerConnected = true;
                    CreateNoloController();
                    break;
                case (int)VrsInstantNativeApi.ViarusControllerId.NORMAL_3DOF:
